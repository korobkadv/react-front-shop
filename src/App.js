      ...
      items: [
        {
          ...
          allDesc: [
            ...
            "Beats For The Streets: Go bigger with 6.5-inch speakers that deliver 100-watts of crystal-clear audio while a dynamic equalizer automatically adjusts for road, wind and engine noise so you never miss a beat.",
            ...
            "Features For Going The Distance: Ride in comfort for longer with keyless ignition, remote-locking hard saddlebags, cruise control and USB charging port.",
          ],
          category: "Indian",
          urlVideo: "https://www.youtube.com/embed/0R4Y5N9iASw",
          price: "36229"
        },
        {
          id: 2,
          ...
          allDesc: [
            "Thunderstroke 116 V-Twin Engine: The air-cooled Thunderstroke 116 engines produces 126 ft-lbs of torque for exceptional power at low RPM and a smooth ride at any speed.",
            "Modern. Aggressive.: Premium chrome finishes, a sleek fairing, slammed saddlebags, and gunfighter style seat deliver a streamlined, commanding presence. A lowered stance and LED lighting from nose to tail complete the custom-inspired look.",
            "Touchscreen Powered By Ride Command: A gorgeous 7-inch touchscreen powered by RIDE COMMAND features Apple CarPlay® integration, turn-by-turn navigation, Bluetooth® connectivity, live traffic and weather, and more.",
            "Agile Handling And Control: Low seat height, ergonomically-designed controls, and a lightweight cast aluminum frame come together for responsive handling and agile cornering — providing a confidence inspiring ride for riders across the board.",
            "Beats For The Streets: Hear every note with high-output speakers in the fairing that deliver 100-watts of crystal-clear audio. The dynamic equalizer automatically adjusts for road, wind, and engine noise.",
          ...
          category: "Indian",
          urlVideo: "https://www.youtube.com/embed/72DeBeE9Iok",
          price: "34999"
        },
        {
          id: 3,
          ...
          allDesc: [
            ...
            "Touchscreen Powered By Ride Command: A gorgeous 7-inch touchscreen powered by RIDE COMMAND features Apple CarPlay® integration, turn-by-turn navigation, Bluetooth® connectivity, live traffic and weather, and more.",
            "Thunderstroke 116 V-Twin Engine: The air-cooled Thunderstroke 116 engine produces 126 ft-lbs of torque for exceptional power at low RPM and smooth ride at any speed.",
            ...
            "Ride In Comfort, Your Way: Choose between three ride modes, Tour, Standard, and Sport, for an experience that's customized to your riding style. Rear Cylinder Deactivation automatically shuts off the rear cylinder when the bike is stopped for enhanced comfort in slow-moving traffic.",
            "A Higher Standard: Top-of-the-line riding amenities include LED lighting, keyless ignition, cruise-control, ABS and tire pressure monitoring."
          ],
          category: "Indian",
          urlVideo: "https://www.youtube.com/embed/kUzG1JHc3Ik",
          price: "38299"
        },
        {
          id: 4,
          ...
          allDesc: [
            "Originality Comes Standard: A name that goes back a century. An experience that lives up to the legacy. The Scout is where heritage-inspired design meets modern performance.",
            "100 Horses. Unleashed: The liquid-cooled, 69-cubic-inch, 100 hp V-twin delivers punchy acceleration and the power to pass anyone, anywhere. Electronic fuel injection delivers class-leading horsepower and acceleration, while a responsive 6-speed transmission allows for sporty, aggressive riding.",
            "Draped In Chrome: Premium chrome provides plenty of head-turning shine. Make a statement that's sure to get noticed.",
            "Two-Up Riding: A genuine leather two-up seat is designed to withstand the elements while maintaining its natural beauty. Passenger pegs come standard.",
          ...
          category: "Indian",
          urlVideo: "https://www.youtube.com/embed/F-s8eUlxhvk",
          price: "16499"
        },
        {
          id: 5,
          ...
          allDesc: [
            "Setting a benchmark for handling and character, the Triumph Rocket 3 R delivers incredible control, comfort and capability. Providing instantaneous, world-leading torque that's an amazing 71% higher than the closest competition, the Rocket 3 serves up effortless acceleration and response in any gear, with a flat, rich curve that reaches its peak at 4,000 rpm then holds maximum torque all the way through the mid-range. ",
            "Peak power is 164 HP at 6,000 rpm (11% up on the previous generation), with more power from a low 3,500 rpm and all the way up to a higher redline of 7,000 rpm, making the Rocket 3 R an unparalleled thrilling riding experience with all-day, any-gear, breathtaking capability. ",
            "On top of its unbeatable performance, the Rocket 3 R has an incredible pure muscular presence and magnificent cruiser style, together with beautiful details and an premium finish. And you can enhance this incredible ride even more by personalizing your ride with over 50 custom accessories.",
          ],
          category: "Triumph",
          urlVideo: "https://www.youtube.com/embed/7pRH-6UTgu8",
          price: "27500"
        },
        {
          id: 6,
          ...
          allDesc: [
            ...
            "rembo Stylema® Brakes: Superior stopping power with top-specification category-leading Brembo Stylema® brakes which are lightweight, compact and carefully sculpted high performance calipers.",
            ...
            "All-LED Lighting: Signature Tiger 900 lighting includes LED headlight, tail light and indicators for maintenance-free visibility."
          ],
          category: "Triumph",
          urlVideo: "https://www.youtube.com/embed/CippTbMxOow",
          price: "17500"
        },
        {
          id: 7,
          ...
          allDesc: [
            ...
            "Big Motor With Big Torque: You'll crush miles with unimaginable low end torque right off the line and exhilarating top end passing power from the liquid-cooled V-twin PowerPlus motor.",
            ...
            "Unsurpassed Comfort: The frame-mounted fairing provides exceptional wind protection on its own. For even more, adjust the vent in the lowers or simply push a button to send up the windshield. While it's considerate to check in on a passenger when you have one, you don't really need to: in this two-up configuration with optional heated seats, they'll be just as comfortable as you.",
            "Premium Audio: High-output speakers in the fairing and trunk deliver 200-watts of crystal-clear audio. It also sports a dynamic equalizer that automatically adjusts for road, wind and engine noise.",
            ...
            "Bright, Bold Lighting: You won't go unnoticed, thanks to LED running lights and a LED headlight with a menacing style."
          ],
          category: "Indian",
          urlVideo: "https://www.youtube.com/embed/FdtJsMLFCdM",
          price: "38199"
        },
        {
          id: 8,
